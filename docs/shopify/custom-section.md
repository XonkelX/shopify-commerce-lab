...
![Three-card product comparison section in the unpublished Shopify storefront](assets/custom-section.png)

[Theme Editor settings and live section preview](assets/phase-1-theme-editor.png)

- **Live demo:** [Open the comparison section](https://oniel-lab.myshopify.com/?preview_theme_id=155175092398)
- **Short demo video:** [Watch the 8-second captured-state walkthrough](assets/custom-section-demo.mp4) (not a live screen recording).
